...
pp' (Call name args) = tshow name <> parens (commaList args) -- TODO: set atomic flag false
pp' (AtomicCall name args) = tshow name <> parens (commaList args) <+> "/* ATOMIC */" -- TODO: set atomic flag true
